...
import com.nano.store.config.audit.AuditEventConverter;
import com.nano.store.domain.PersistentAuditEvent;
...
import static com.nano.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
