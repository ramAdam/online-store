...
public interface OrderItemRepository extends JpaRepository<OrderItem, Long> {
    ...
    @Query(
        value = "select distinct orderItem from OrderItem orderItem left join fetch orderItem.order",
    ...
    @Query("select distinct orderItem from OrderItem orderItem left join fetch orderItem.order")
